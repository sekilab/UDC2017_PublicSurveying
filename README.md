...
「Ubiquitous Surveying ~暮らしを支える公共測量~」は，アーバンデータチャレンジ2017データ部門に応募する目的で作成されたページです．
以下では，本ページで取り扱うデータについて説明します．

## 公開するデータの概要

このページでは，国土地理院の技術資料の一つである「公共測量の記録」を電子化し，各種分析等に利用可能な形にした電子データ(csv形式)を公開しています．
「公共測量の記録」は，前回の東京オリンピックの開催された昭和39(1964)年から発行されており，日本で行われている測量の大半を担う公共測量の基本的な情報を示しています．
しかしながら，平成13(2001)年度までは紙媒体により発行され，その後はPDF形式で公開されているため， 直接分析を行うことは困難でありました．

今回公開する，日本の測量の実態を伝える貴重な資料である「公共測量の記録」を利用した分析が進むことで，この国土において行われた測量，そしてこの国土を去来した測量人の活躍について，より多くの人に知っていただく一助となることを願っています．
...
* 従って，厳密な意味では原資料を直接電子化したものとはなっていませんが，分析を行う際に必要な修正は予め実施された形となっています．  <br>
...
1. 原資料中でパンチングされているなどして，資料の一部に欠損がある場合があります．  
　詳細は"欠損箇所.xlsx"を参照のこと．  
...
例)<br>
国土地理院技術資料「公共測量の記録　平成○○年度」(資料番号：●●)をもとに東京大学生産技術研究所関本研究室が加工したデータを利用した<br>
